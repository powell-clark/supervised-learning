...
- [ ] **Host protection.** Measured 2026-09-05: 16 cores, 31 GB RAM but `MemAvailable` only **4.0–6.4 GB** (the operator runs ~52 live Claude sessions across 32 tmux panes, 12.6 GB RSS); disk freed to 83% with 71 GB available. The guards are sized to the ~4 GB floor:
