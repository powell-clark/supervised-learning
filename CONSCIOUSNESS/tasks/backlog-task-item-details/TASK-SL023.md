...
> **Relocated 2026-09-05:** this is a consciousness-plugin bug in packages/core/review/readiness.js, not supervised-learning content — filed as TASK-CCC31370 in the consciousness repo per operator ruling that loop-behaviour observations go to CCC, not a consumer repo. Left open here for the operator to close or keep as a local pointer.
